...
public class A_PacketHandler {
    ...
    public static void register() {
        ...
        INSTANCE.messageBuilder(ComponentToggleExtendTabPacket.class, id(), NetworkDirection.PLAY_TO_SERVER)
                ...
                .add();
        INSTANCE.messageBuilder(UseMobPartAbilityPacket.class, id(), NetworkDirection.PLAY_TO_SERVER)
                .decoder(UseMobPartAbilityPacket::new)
                .encoder(UseMobPartAbilityPacket::toBytes)
                .consumerMainThread(UseMobPartAbilityPacket::handle)
                .add();
        INSTANCE.messageBuilder(MobAbilityCooldownPacket.class, id(), NetworkDirection.PLAY_TO_CLIENT)
                .decoder(MobAbilityCooldownPacket::fromBytes)
                .encoder(MobAbilityCooldownPacket::toBytes)
                .consumerMainThread(MobAbilityCooldownPacket::handle)
                .add();
        INSTANCE.messageBuilder(GuardianLaserPacket.class, id(), NetworkDirection.PLAY_TO_CLIENT)
                .decoder(GuardianLaserPacket::fromBytes)
                .encoder(GuardianLaserPacket::toBytes)
                .consumerMainThread(GuardianLaserPacket::handle)
                .add();
