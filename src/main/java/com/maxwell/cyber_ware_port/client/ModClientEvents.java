...
import com.maxwell.cyber_ware_port.client.upgrades.MobPartPlayerLayer;
    ...
    public static void onAddLayers(EntityRenderersEvent.AddLayers event) {
        for (String skinType : new String[]{"default", "slim"}) {
            ...
            if (renderer != null) {
                ...
                // 生物部位外观层:渲染玩家身上安装的 mob_part,需在 CyberwarePlayerLayer 之后添加
                renderer.addLayer(new MobPartPlayerLayer(renderer, net.minecraft.client.Minecraft.getInstance().getEntityModels()));
            }
        }
    }
