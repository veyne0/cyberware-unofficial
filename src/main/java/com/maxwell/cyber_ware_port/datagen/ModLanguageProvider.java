...
public class ModLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        if (locale.equals("zh_cn")) {
            add("itemGroup.cyberware_unofficial.items", "机械改造");
            add("emi.category.cyberware_unofficial.assembly", "组装");
            add("emi.category.cyberware_unofficial.engineering", "工程");
            ...
            add("tooltip.cyberware_unofficial.charger", "站在上面即可进行充电/放电的方块");
            add("tooltip.cyberware_unofficial.charger2", "右键点击可切换充电/放电模式。");
            add("tooltip.cyberware_unofficial.charger3", "充电模式下优先吸收电力。放电模式下优先输出电力。");
            ...
            add("item.cyberware_unofficial.component_box", "元件收纳盒");
            add(ModBlocks.BLUEPRINT_CHEST.get(), "蓝图档案室");
            add("cyberware.tooltip.eventCost", "激活消耗：%s");
            add(ModBlocks.SCANNER.get(), "机械扫描仪");
            add("message.cyberware_unofficial.no_hud_installed", "请安装机械眼。");
            add("gui.cyberware_unofficial.scanner.chance", "[有 %s%% 的几率获得蓝图并使用义体]");
            add("gui.cyberware_unofficial.need_paper", "需要纸张。");
            add("gui.cyberware_unofficial.assemble", "组装");
            add("gui.cyberware_unofficial.deconstruct", "拆解");
            add("gui.cyberware_unofficial.blueprint_chance", "有 %s%% 的概率获得蓝图");
            add("gui.cyberware_unofficial.installed_cyberware.title", "术后电子义体状态");
            add("gui.cyberware_unofficial.button.view_installed", "索引");
            add("gui.cyberware_unofficial.menu", "电子义体菜单");
            ...
            add("key.cyberware_unofficial.menu", "打开电子义体菜单");
            add("key.categories.cyberware_unofficial", "电子义体");
            add("cyberware_slot.cyberware_unofficial.eyes", "眼部插槽");
            add("cyberware_slot.cyberware_unofficial.brain", "颅部插槽");
            add("cyberware_slot.cyberware_unofficial.heart", "心脏插槽");
            add("cyberware_slot.cyberware_unofficial.lungs", "肺部插槽");
            add("cyberware_slot.cyberware_unofficial.stomach", "腹腔器官插槽");
            add("cyberware_slot.cyberware_unofficial.arms", "臂部插槽");
            add("cyberware_slot.cyberware_unofficial.hands", "手部插槽");
            add("cyberware_slot.cyberware_unofficial.legs", "腿部插槽");
            add("cyberware_slot.cyberware_unofficial.boots", "脚部插槽");
            add("cyberware_slot.cyberware_unofficial.head", "头部插槽");
            add("cyberware_slot.cyberware_unofficial.torso", "躯干插槽");
            add("cyberware_slot.cyberware_unofficial.skin", "皮肤插槽");
            add("cyberware_slot.cyberware_unofficial.muscle", "肌肉插槽");
            add("cyberware_slot.cyberware_unofficial.bones", "骨骼插槽");
            add("cyberware_slot.cyberware_unofficial.unknown", "未知");
            ...
            add("tooltip.cyberware_unofficial.radio_tower_core", "吸引附近的赛博格类生物，但单独无法工作。");
            add("tooltip.cyberware_unofficial.radio_kit", "吸引64格内的赛博格类生物。");
            add("tooltip.cyberware_unofficial.component_box", "可放入零件，附近有机械工程桌时会增加标签页。");
            add("tooltip.cyberware_unofficial.scanner", "扫描电子义体，有50%的概率生成蓝图。");
            add("tooltip.cyberware_unofficial.radio_component", "无线电信标零件");
            add("tooltip.cyberware_unofficial.radio_component2", "在下方3x3范围内放置4层零件");
            add("tooltip.cyberware_unofficial.radio_component3", "在上方中央放置6层单个零件");
            add("tooltip.cyberware_unofficial.surgery_chamber", "代替机械手术核心执行手术。");
            add("tooltip.cyberware_unofficial.surgery_chamber2", "预约手术后，进入其中并关门即可工作。");
            add("tooltip.cyberware_unofficial.blueprint_chest", "可放入蓝图，附近有机械工程桌时会增加标签页。");
            add("tooltip.cyberware_unofficial.cyberware_workbench", "可以分解和制作电子义体。");
            add("tooltip.cyberware_unofficial.robo_surgeon", "用于设置移植和摘除的电子义体。");
            add("tooltip.cyberware_unofficial.robo_surgeon2", "放置在手术室上方才能工作。");
        ...
        if (locale.equals("ru_ru")) {
            add("emi.category.cyberware_unofficial.assembly", "Сборка");
            add("emi.category.cyberware_unofficial.engineering", "Инженерия");
            ...
            add("tooltip.cyberware_unofficial.charger", "Блок, позволяющий заряжать/разряжать энергию, стоя на нём");
            add("tooltip.cyberware_unofficial.charger2", "Нажмите ПКМ, чтобы переключить режим зарядки/разрядки.");
            add("tooltip.cyberware_unofficial.charger3", "В режиме зарядки приоритет отдаётся поглощению энергии, в режиме разрядки — отдаче.");
            add("itemGroup.cyberware_unofficial.items", "Cyberware");
            ...
            add("item.cyberware_unofficial.component_box", "Коробка частей");
            add(ModBlocks.BLUEPRINT_CHEST.get(), "Архив для чертежей");
            add(ModBlocks.SCANNER.get(), "Кибер-сканер");
            add("message.cyberware_unofficial.no_hud_installed", "Пожалуйста, установите кибер-глаза.");
            ...
            add("gui.cyberware_unofficial.scanner.chance", "[%s%% Шанс]");
            add("gui.cyberware_unofficial.need_paper", "Требуется бумага.");
            add("gui.cyberware_unofficial.assemble", "Собрать");
            add("gui.cyberware_unofficial.deconstruct", "Разобрать");
            add("gui.cyberware_unofficial.blueprint_chance", "[%s%% шанс получить чертеж и использовать кибернетические имплантаты]");
            add("gui.cyberware_unofficial.installed_cyberware.title", "Статус кибер-устройств после операции");
            add("gui.cyberware_unofficial.button.view_installed", "Индекс");
            add("gui.cyberware_unofficial.menu", "Кибер-меню");
            ...
            add("key.keyboard.shift", "Shift");
            add("key.cyberware_unofficial.menu", "Открыть кибер-меню");
            add("key.categories.cyberware_unofficial", "Cyberware");
            add("cyberware_slot.cyberware_unofficial.eyes", "Слот глаз");
            add("cyberware_slot.cyberware_unofficial.brain", "Слот черепа");
            add("cyberware_slot.cyberware_unofficial.heart", "Слот сердца");
            add("cyberware_slot.cyberware_unofficial.lungs", "Слот легких");
            add("cyberware_slot.cyberware_unofficial.stomach", "Слот нижних органов");
            add("cyberware_slot.cyberware_unofficial.arms", "Слот для рук");
            add("cyberware_slot.cyberware_unofficial.hands", "Слот для рук");
            add("cyberware_slot.cyberware_unofficial.legs", "Слот для ног");
            add("cyberware_slot.cyberware_unofficial.boots", "Слот для ног");
            add("cyberware_slot.cyberware_unofficial.head", "Слот головы");
            add("cyberware_slot.cyberware_unofficial.torso", "Слот торса");
            add("cyberware_slot.cyberware_unofficial.skin", "Слот для кожи");
            add("cyberware_slot.cyberware_unofficial.muscle", "Слот мышц");
            add("cyberware_slot.cyberware_unofficial.bones", "Слот костей");
            add("cyberware_slot.cyberware_unofficial.unknown", "Неизвестно");
            ...
            add("tooltip.cyberware_unofficial.radio_tower_core", "Привлекает ближайших кибер-мобов, но не работает само по себе.");
            add("tooltip.cyberware_unofficial.radio_kit", "Привлекает кибер-мобов в радиусе 64 блоков.");
            add("tooltip.cyberware_unofficial.component_box", "Может хранить компоненты, добавляет вкладку, если рядом есть кибер-верстак.");
            add("tooltip.cyberware_unofficial.scanner", "Сканирует кибер-устройства с 50% шансом создать чертеж.");
            add("tooltip.cyberware_unofficial.radio_component", "Компонент радиомаяка");
            add("tooltip.cyberware_unofficial.radio_component2", "Разместите компоненты в области 3x3, 4 слоя в высоту снизу.");
            add("tooltip.cyberware_unofficial.radio_component3", "Разместите один столбец компонентов высотой 6 слоев в центре сверху.");
            add("tooltip.cyberware_unofficial.surgery_chamber", "Выполняет операции для робохирурга.");
            add("tooltip.cyberware_unofficial.surgery_chamber2", "Функционирует при входе и закрытии двери после назначения операции.");
            add("tooltip.cyberware_unofficial.blueprint_chest", "Может хранить чертежи, добавляет вкладку, если рядом есть кибер-верстак.");
            add("tooltip.cyberware_unofficial.cyberware_workbench", "Может разбирать и создавать кибер-устройства.");
            add("tooltip.cyberware_unofficial.robo_surgeon", "Используется для настройки установки и извлечения кибер-устройств.");
            add("tooltip.cyberware_unofficial.robo_surgeon2", "Функционирует при размещении на операционной.");
        ...
        if (locale.equals("fr_fr")) {
            add("emi.category.cyberware_unofficial.assembly", "Assemblage");
            add("emi.category.cyberware_unofficial.engineering", "Ingénierie");
            ...
            add("tooltip.cyberware_unofficial.charger", "Un bloc qui permet de charger/décharger en se tenant dessus");
            add("tooltip.cyberware_unofficial.charger2", "Clic droit pour basculer entre le mode charge et décharge.");
            add("tooltip.cyberware_unofficial.charger3", "En mode charge, il absorbe l'énergie en priorité. En mode décharge, il libère l'énergie en priorité.");
            add("itemGroup.cyberware_unofficial.items", "Cyberware");
            ...
            add("item.cyberware_unofficial.component_box", "Boîte à Composants");
            add(ModBlocks.BLUEPRINT_CHEST.get(), "Banque de Schémas");
            add(ModBlocks.SCANNER.get(), "Scanner Cybernétique");
            add("message.cyberware_unofficial.no_hud_installed", "Veuillez installer des Cyberyeux.");
            ...
            add("gui.cyberware_unofficial.scanner.chance", "[%s%% de Chance]");
            add("gui.cyberware_unofficial.need_paper", "Papier requis.");
            add("gui.cyberware_unofficial.assemble", "Assembler");
            add("gui.cyberware_unofficial.deconstruct", "Déconstruire");
            add("gui.cyberware_unofficial.blueprint_chance", "[%s%% de chances d'obtenir un plan et de consommer des implants cybernétiques]");
            add("gui.cyberware_unofficial.installed_cyberware.title", "État du Cyberware Post-Opératoire");
            add("gui.cyberware_unofficial.button.view_installed", "Index");
            add("gui.cyberware_unofficial.menu", "Menu Cyberware");
            add("cyberware.gui.active.enable", "Activer");
            add("cyberware.gui.active.disable", "Désactiver");
            add("cyberware.gui.active.zoom", "Zoom");
            add("key.keyboard.shift", "Shift");
            add("key.cyberware_unofficial.menu", "Ouvrir le Menu Cyberware");
            add("key.categories.cyberware_unofficial", "Cyberware");
            add("cyberware_slot.cyberware_unofficial.eyes", "Emplacement Yeux");
            add("cyberware_slot.cyberware_unofficial.brain", "Emplacement Crâne");
            add("cyberware_slot.cyberware_unofficial.heart", "Emplacement Cœur");
            add("cyberware_slot.cyberware_unofficial.lungs", "Emplacement Poumons");
            add("cyberware_slot.cyberware_unofficial.stomach", "Emplacement Organes Inférieurs");
            add("cyberware_slot.cyberware_unofficial.arms", "Emplacement Bras");
            add("cyberware_slot.cyberware_unofficial.hands", "Emplacement Mains");
            add("cyberware_slot.cyberware_unofficial.legs", "Emplacement Jambes");
            add("cyberware_slot.cyberware_unofficial.boots", "Emplacement Pieds");
            add("cyberware_slot.cyberware_unofficial.head", "Emplacement Tête");
            add("cyberware_slot.cyberware_unofficial.torso", "Emplacement Torse");
            add("cyberware_slot.cyberware_unofficial.skin", "Emplacement Peau");
            add("cyberware_slot.cyberware_unofficial.muscle", "Emplacement Muscles");
            add("cyberware_slot.cyberware_unofficial.bones", "Emplacement Os");
            add("cyberware_slot.cyberware_unofficial.unknown", "Inconnu");
            ...
            add("tooltip.cyberware_unofficial.radio_tower_core", "Attire les monstres de type cyber proches, mais ne fonctionne pas seul.");
            add("tooltip.cyberware_unofficial.radio_kit", "Attire les monstres de type cyber dans un rayon de 64 blocs.");
            add("tooltip.cyberware_unofficial.component_box", "Peut contenir des composants, ajoute un onglet si une Table d'Ingénierie Cybernétique est à proximité.");
            add("tooltip.cyberware_unofficial.scanner", "Scanne le Cyberware avec 50% de chance de créer un schéma.");
            add("tooltip.cyberware_unofficial.radio_component", "Composant de Balise Radio");
            add("tooltip.cyberware_unofficial.radio_component2", "Placez les composants dans une zone de 3x3, 4 couches de haut en bas.");
            add("tooltip.cyberware_unofficial.radio_component3", "Placez une seule colonne de composants de 6 couches de haut au centre, en haut.");
            add("tooltip.cyberware_unofficial.surgery_chamber", "Effectue les opérations pour le Robochirurgien.");
            add("tooltip.cyberware_unofficial.surgery_chamber2", "Fonctionne en y entrant et en fermant la porte après avoir programmé une opération.");
            add("tooltip.cyberware_unofficial.blueprint_chest", "Peut contenir des schémas, ajoute un onglet si une Table d'Ingénierie Cybernétique est à proximité.");
            add("tooltip.cyberware_unofficial.cyberware_workbench", "Peut déconstruire et fabriquer du Cyberware.");
            add("tooltip.cyberware_unofficial.robo_surgeon", "Utilisé pour définir le Cyberware à installer et à retirer.");
            add("tooltip.cyberware_unofficial.robo_surgeon2", "Fonctionne lorsqu'il est placé sur une Chambre de Chirurgie.");
        ...
        if (locale.equals("en_us")) {
            add("emi.category.cyberware_unofficial.assembly", "Assembly");
            add("emi.category.cyberware_unofficial.engineering", "Engineering");
            add("itemGroup.cyberware_unofficial.items", "Cyberware");
            add("cyberware.gui.no_active", "No cyberware");
            add("tooltip.cyberware_unofficial.charger", "A block that allows charging/discharging by standing on it");
            add("tooltip.cyberware_unofficial.charger2", "Right-click to toggle between charge and discharge modes.");
            add("tooltip.cyberware_unofficial.charger3", "In charge mode, it prioritizes absorbing power. In discharge mode, it prioritizes releasing power.");
            ...
            add("item.cyberware_unofficial.component_box", "Component Box");
            add(ModBlocks.BLUEPRINT_CHEST.get(), "Blueprint Archive");
            add(ModBlocks.SCANNER.get(), "Scanner");
            add("message.cyberware_unofficial.no_hud_installed", "Please install Cybereyes.");
            ...
            add("gui.cyberware_unofficial.scanner.chance", "[%s%% Chance]");
            add("gui.cyberware_unofficial.need_paper", "Paper is required.");
            add("gui.cyberware_unofficial.assemble", "Assemble");
            add("gui.cyberware_unofficial.deconstruct", "Deconstruct");
            add("gui.cyberware_unofficial.blueprint_chance", "[%s%% chance to obtain a blueprint and consume cyberware]");
            add("gui.cyberware_unofficial.installed_cyberware.title", "Post-Surgery Cyberware Status");
            add("gui.cyberware_unofficial.button.view_installed", "Index");
            add("gui.cyberware_unofficial.menu", "Cyberware Menu");
            add("cyberware.gui.active.enable", "Enable");
            add("cyberware.gui.active.disable", "Disable");
            add("cyberware.gui.active.zoom", "Zoom");
            add("key.keyboard.shift", "Shift");
            add("key.cyberware_unofficial.menu", "Open Cyberware Menu");
            add("key.categories.cyberware_unofficial", "Cyberware");
            add("cyberware_slot.cyberware_unofficial.eyes", "Eyes Slot");
            add("cyberware_slot.cyberware_unofficial.brain", "Cranium Slot");
            add("cyberware_slot.cyberware_unofficial.heart", "Heart Slot");
            add("cyberware_slot.cyberware_unofficial.lungs", "Lungs Slot");
            add("cyberware_slot.cyberware_unofficial.stomach", "Lower Organs Slot");
            add("cyberware_slot.cyberware_unofficial.arms", "Arm Slot");
            add("cyberware_slot.cyberware_unofficial.hands", "Hand Slot");
            add("cyberware_slot.cyberware_unofficial.legs", "Leg Slot");
            add("cyberware_slot.cyberware_unofficial.boots", "Foot Slot");
            add("cyberware_slot.cyberware_unofficial.head", "Head Slot");
            add("cyberware_slot.cyberware_unofficial.torso", "Torso Slot");
            add("cyberware_slot.cyberware_unofficial.skin", "Skin Slot");
            add("cyberware_slot.cyberware_unofficial.muscle", "Muscle Slot");
            add("cyberware_slot.cyberware_unofficial.bones", "Bone Slot");
            add("cyberware_slot.cyberware_unofficial.unknown", "Unknown");
            ...
            add("tooltip.cyberware_unofficial.radio_tower_core", "Attracts nearby cyber-type mobs, but does not function on its own.");
            add("tooltip.cyberware_unofficial.radio_kit", "Attracts cyber-type mobs within 64 blocks.");
            add("tooltip.cyberware_unofficial.component_box", "Can hold components, adds a tab if a Cyberware Workbench is nearby.");
            add("tooltip.cyberware_unofficial.scanner", "Scans Cyberware with a 50% chance to create a blueprint.");
            add("tooltip.cyberware_unofficial.radio_component", "Radio Beacon Component");
            add("tooltip.cyberware_unofficial.radio_component2", "Place components in a 3x3 area, 4 layers high on the bottom.");
            add("tooltip.cyberware_unofficial.radio_component3", "Place a single column of components 6 layers high in the center on top.");
            add("tooltip.cyberware_unofficial.surgery_chamber", "Performs operations for the Robo Surgeon.");
            add("tooltip.cyberware_unofficial.surgery_chamber2", "Functions by entering it and closing the door after scheduling an operation.");
            add("tooltip.cyberware_unofficial.blueprint_chest", "Can hold blueprints, adds a tab if a Cyberware Workbench is nearby.");
            add("tooltip.cyberware_unofficial.cyberware_workbench", "Can deconstruct and craft Cyberware.");
            add("tooltip.cyberware_unofficial.robo_surgeon", "Used to set Cyberware for installation and removal.");
            add("tooltip.cyberware_unofficial.robo_surgeon2", "Functions when placed on top of a Surgery Chamber.");
        ...
        if (locale.equals("ja_jp")) {
            add("emi.category.cyberware_unofficial.assembly", "組み立て");
            add("emi.category.cyberware_unofficial.engineering", "分解");
            add("itemGroup.cyberware_unofficial.items", "サイバーウェア");
            ...
            add("tooltip.cyberware_unofficial.charger", "上に乗ることで充電/放電が出来るブロック");
            add("tooltip.cyberware_unofficial.charger2", "右クリックで充電/放電モードを切り替えて使用できる。");
            add("tooltip.cyberware_unofficial.charger3", "充電モードでは電力を優先的に吸収する。放電モードでは電力を優先的に排出する。");
            ...
            add("message.cyberware_unofficial.no_hud_installed", "サイバーアイをインストールしてください。");
            add(ModBlocks.CYBERWARE_WORKBENCH.get(), "サイバーウェア工作台");
            add(ModBlocks.COMPONENT_BOX.get(), "部品ボックス");
            add("item.cyberware_unofficial.component_box", "部品ボックス");
            ...
            add("gui.cyberware_unofficial.scanner.chance", "[%s%% の確率でCyberwareを消費]");
            add("gui.cyberware_unofficial.need_paper", "紙が必要です。");
            add("gui.cyberware_unofficial.assemble", "組み立て");
            add("gui.cyberware_unofficial.deconstruct", "分解");
            add("gui.cyberware_unofficial.blueprint_chance", "%s%%の確率で設計図を獲得");
            add("gui.cyberware_unofficial.installed_cyberware.title", "サイバーウェア手術後の状態");
            add("gui.cyberware_unofficial.button.view_installed", "索引");
            add("gui.cyberware_unofficial.menu", "サイバーウェアメニュー");
            ...
            add("key.keyboard.shift", "Shift");
            add("key.cyberware_unofficial.menu", "サイバーウェアメニューを開く");
            add("key.categories.cyberware_unofficial", "サイバーウェア");
            add("cyberware_slot.cyberware_unofficial.eyes", "眼球スロット");
            add("cyberware_slot.cyberware_unofficial.brain", "頭蓋スロット");
            add("cyberware_slot.cyberware_unofficial.heart", "心臓スロット");
            add("cyberware_slot.cyberware_unofficial.lungs", "肺スロット");
            add("cyberware_slot.cyberware_unofficial.stomach", "下腹部の臓器スロット");
            add("cyberware_slot.cyberware_unofficial.arms", "腕部スロット");
            add("cyberware_slot.cyberware_unofficial.hands", "手スロット");
            add("cyberware_slot.cyberware_unofficial.legs", "脚部スロット");
            add("cyberware_slot.cyberware_unofficial.boots", "足スロット");
            add("cyberware_slot.cyberware_unofficial.head", "頭部スロット");
            add("cyberware_slot.cyberware_unofficial.torso", "胴体スロット");
            add("cyberware_slot.cyberware_unofficial.skin", "皮膚スロット");
            add("cyberware_slot.cyberware_unofficial.muscle", "筋肉スロット");
            add("cyberware_slot.cyberware_unofficial.bones", "骨格スロット");
            add("cyberware_slot.cyberware_unofficial.unknown", "不明");
            ...
            add("tooltip.cyberware_unofficial.radio_tower_core", "周囲のサイバー系モブを引き寄せますが、単体だと機能しません。");
            add("tooltip.cyberware_unofficial.radio_kit", "64ブロック以内のサイバー系モブを引き寄せます。");
            add("tooltip.cyberware_unofficial.component_box", "部品を入れられます、近くにサイバーウェア工作台があるならタブを追加します。");
            add("tooltip.cyberware_unofficial.scanner", "サイバーウェアを調査して50%の確立で設計図を書き出します。");
            add("tooltip.cyberware_unofficial.radio_component", "ラジオビーコンの部品");
            add("tooltip.cyberware_unofficial.radio_component2", "下段に3x3の範囲で4層に構成部品を設置");
            add("tooltip.cyberware_unofficial.radio_component3", "上段の中央に1本の構成部品を6層に設置");
            add("tooltip.cyberware_unofficial.surgery_chamber", "ロボ外科医のオペを代行します。");
            add("tooltip.cyberware_unofficial.surgery_chamber2", "オペの予約後、内部に入りドアを閉じることで機能します。");
            add("tooltip.cyberware_unofficial.blueprint_chest", "設計図を入れられます、近くにサイバーウェア工作台があるならタブを追加します。");
            add("tooltip.cyberware_unofficial.cyberware_workbench", "サイバーウェアの分解と制作ができます。");
            add("tooltip.cyberware_unofficial.robo_surgeon", "サイバーウェアの移植と摘出の設定に使用します。");
            add("tooltip.cyberware_unofficial.robo_surgeon2", "手術室の上に置くことで機能します。");
