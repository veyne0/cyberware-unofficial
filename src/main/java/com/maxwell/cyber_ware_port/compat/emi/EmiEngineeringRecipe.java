...
public class EmiEngineeringRecipe implements EmiRecipe {
    ...
    public void addWidgets(WidgetHolder widgets) {
        ...
        widgets.addSlot(EmiStack.of(Items.PAPER), 15, 53).drawBack(false)
                .appendTooltip(Component.translatable("gui.cyberware_unofficial.need_paper").withStyle(ChatFormatting.GRAY));
        ...
        if (!blueprint.isEmpty()) {
            ...
            widgets.addSlot(blueprint, 114, 52).drawBack(false)
                    .appendTooltip(Component.translatable("gui.cyberware_unofficial.blueprint_chance", String.format("%.0f", bpChance)).withStyle(ChatFormatting.BLUE));
        }
    }
}